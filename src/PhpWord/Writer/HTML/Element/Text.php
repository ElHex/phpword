...
class Text extends AbstractElement
{
    ...
    private function getParagraphStyle()
    {
        ...
        if($paragraphStyle != null && $paragraphStyle->getLineHeight() != null && (empty($style) || strpos($style, 'line-height') !== FALSE)) {
            $style = " style=\"line-height: ".number_format($paragraphStyle->getLineHeight(), 1, '.', ',').";\" ";
        }
        return $style;
    }
